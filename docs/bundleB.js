//Blue are white women -- some are TS fans, a bit hard to distinguish.  Orange are asian men -- the people who are TS fans are more distinguishable.  
...
explanation(svg, ['% of TS fans', 'served'], 0, topY);
explanation(svg, ['% of non-TS fans', 'served'], 100, topY);
explanation(svg, ['% of TS fans', 'not served'], 200, topY);
explanation(svg, ['% of all', 'served ads'], 300, topY);
